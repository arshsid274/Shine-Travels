          ...
          !(function () {
            ...
            (o.set = function (e, t, n) {
              ...
              (o.scale = function (e, n, r, s) {
                ...
                if (
                  (e.circleRadius &&
                    (n === r ? (e.circleRadius *= n) : (e.circleRadius = null)),
                  !e.isStatic)
                ) {
                  var u = t(e);
                  (e.area = u.area),
              ...
              (o.update = function (e, t, n, o) {
                ...
                for (var p = 0; p < e.parts.length; p++) {
                  ...
                  i.translate(m.vertices, e.velocity),
                    p > 0 &&
                      ((m.position.x += e.velocity.x),
                      (m.position.y += e.velocity.y)),
                    0 !== e.angularVelocity &&
                      (i.rotate(m.vertices, e.angularVelocity, e.position),
            ...
            var t = function (e) {
              for (
                ...
                (t.mass += o.mass),
                  ...
                  (t.centre = r.add(
                    t.centre,
                    r.mult(o.position, o.mass !== 1 / 0 ? o.mass : 1)
                  ));
              }
              return (
                (t.centre = r.div(
            ...
            (o.scale = function (e, t, n, i, r) {
              for (
                ...
                var c = a[l],
                  d = c.position.x - i.x,
                  u = c.position.y - i.y;
                s.setPosition(c, { x: i.x + d * t, y: i.y + u * n }),
                  s.scale(c, t, n);
              }
              return o.setModified(e, !0, !0, !1), e;
            });
            ...
            for (var n = [], a = t.pairs.table, l = 0; l < e.length; l++) {
              ...
              if (
                ...
                for (
                  ...
                  for (
                    var p = c.parts[u], m = d.parts.length > 1 ? 1 : 0;
                    m < d.parts.length;
                    m++
                  ) {
                    var f = d.parts[m];
          ...
          (o.create = function (e) {
            ...
            (o.update = function (e, t, n) {
              var o,
                ...
                f = [];
              for (
                u.length = 0, p.length = 0, m.length = 0, l = 0;
                l < t.length;
                l++
              )
                (o = t[l]).collided &&
                  ...
                  f.push(s),
                  (a = d[s])
                    ? (a.isActive ? m.push(a) : u.push(a), i.update(a, o, n))
                    : ((a = i.create(o, n)), (d[s] = a), u.push(a), c.push(a)));
            ...
            (o.removeOld = function (e, t) {
              ...
              for (r = 0; r < s.length; r++)
                (o = (n = s[r]).collision).bodyA.isSleeping ||
                o.bodyB.isSleeping
                  ? (n.timeUpdated = t)
                  : t - n.timeUpdated > 1e3 && l.push(r);
              for (r = 0; r < l.length; r++)
                delete a[(n = s[(i = l[r] - r)]).id], s.splice(i, 1);
            }),
            (o.clear = function (e) {
              return (
                (e.table = {}),
      ...
      9: [
        function (e, t, n) {
          ...
          (o.ray = function (e, t, n, o) {
            ...
            for (
              var l = i.angle(t, n),
                c = i.magnitude(i.sub(t, n)),
                d = 0.5 * (n.x + t.x),
                u = 0.5 * (n.y + t.y),
                p = a.rectangle(d, u, c, o, { angle: l }),
                m = [],
                f = 0;
              f < e.length;
              f++
            ...
            (o.solvePosition = function (e, t) {
              ...
              for (n = 0; n < e.length; n++)
                (i = e[n]).isActive &&
                  ...
                  (c = s.normal),
                  (d = r.sub(
                    r.add(l.positionImpulse, l.position, m),
                    r.add(
                      a.positionImpulse,
                      r.sub(l.position, s.penetration, f),
                      v
                    ),
                    y
                  )),
                ...
                if (m.isActive && !m.isSensor) {
                  ...
                  for (var w = 0; w < h.length; w++) {
                    var S = h[w],
                      ...
                      _ = (1 + m.restitution) * I,
                      E =
                        s.clamp(m.separation + I, 0, 1) *
                        o._frictionNormalMultiplier,
                      F = T,
                      O = 1 / 0;
                    V > m.friction * m.frictionStatic * E * n &&
                      ((O = V), (F = s.clamp(m.friction * R * n, -O, O)));
                    var L = r.cross(A, g),
                      W = r.cross(P, g),
                      q =
                        b /
                        (v.inverseMass +
                          y.inverseMass +
                          v.inverseInertia * L * L +
                          y.inverseInertia * W * W);
                    if (
                      ((_ *= q),
                      (F *= q),
          ...
          !(function () {
            o.collides = function (t, o, s) {
              ...
              if (s) {
                ...
                (u = s && s.collided && f < 0.2), (d = s);
              } else d = { collided: !1, bodyA: t, bodyB: o };
              if (s && u) {
                var v = d.axisBody,
                  y = v === t ? o : t,
                  g = [v.axes[s.axisNumber]];
                if (
                  ((c = e(v.vertices, y.vertices, g)),
                  (d.reused = !0),
                  c.overlap <= 0)
                )
              ...
              (d.bodyA = t.id < o.id ? t : o),
                ...
                (t = d.bodyA),
                (o = d.bodyB),
                r.dot(c.axis, r.sub(o.position, t.position)) < 0
                  ? (d.normal = { x: c.axis.x, y: c.axis.y })
                  : (d.normal = { x: -c.axis.x, y: -c.axis.y }),
              ...
              var x = n(t, o, d.normal),
                h = [];
              if (
                (i.contains(t.vertices, x[0]) && h.push(x[0]),
      ...
      12: [
        function (e, t, n) {
          ...
          !(function () {
            ...
            (o.create = function (t) {
              var n = t;
              n.bodyA && !n.pointA && (n.pointA = { x: 0, y: 0 }),
                n.bodyB && !n.pointB && (n.pointB = { x: 0, y: 0 });
              ...
              return (
                (n.render = c.extend(
                  { visible: !0, lineWidth: 2, strokeStyle: "#ffffff" },
                  n.render
                )),
                (n.id = n.id || c.nextId()),
              ...
              (o.solve = function (t, n) {
                ...
                o &&
                  !o.isStatic &&
                  ((t.pointA = r.rotate(s, o.angle - t.angleA)),
                  (t.angleA = o.angle)),
                  i &&
                    !i.isStatic &&
                    ((t.pointB = r.rotate(a, i.angle - t.angleB)),
                    (t.angleB = i.angle));
                var l = s,
                  c = a;
                if (
                  (o && (l = r.add(o.position, s)),
                  ...
                  var p = (u - t.length) / u,
                    m = r.div(d, u),
                    f = r.mult(d, 0.5 * p * t.stiffness * n * n);
                  if (!(Math.abs(1 - u / t.length) < 0.001 * n)) {
                    var v, y, g, x, h, b, w, S;
                    o && !o.isStatic
                      ? ((g = {
                        ...
                        (v = r.add(
                          o.velocity,
                          r.mult(r.perp(g), o.angularVelocity)
                        )),
                        (h = r.dot(g, m)),
                        (w = o.inverseMass + o.inverseInertia * h * h))
                      : ((v = { x: 0, y: 0 }), (w = o ? o.inverseMass : 0)),
                      i && !i.isStatic
                        ? ((x = {
                  ...
                  if (0 !== o.x || 0 !== o.y || 0 !== o.angle) {
                    ...
                    for (var c = 0; c < n.parts.length; c++) {
                      ...
                      i.translate(d.vertices, o),
                        c > 0 && ((d.position.x += o.x), (d.position.y += o.y)),
                        0 !== o.angle &&
                          (i.rotate(d.vertices, o.angle, n.position),
          ...
          !(function () {
            (o.create = function (e, t) {
              (t = (t = m.isElement(e) ? t : e) || {}),
                ((e = m.isElement(e) ? e : null) || t.render) &&
                  m.warn(
              ...
              (o.update = function (o, i, a) {
                ...
                for (
                  o.enableSleeping && r.update(x, f.timeScale),
                    t(x, m.gravity),
                    n(x, i, f.timeScale, a, m.bounds),
                    c = 0;
                  c < o.constraintIterations;
                  c++
                )
                  p.solveAll(h, f.timeScale);
                p.postSolveAll(x),
                  v.controller
                    ? (m.isModified && v.controller.clear(v),
          ...
          !(function () {
            (o.create = function (t) {
              ...
              return (
                ...
                (n.absolute = { x: 0, y: 0 }),
                (n.position = { x: 0, y: 0 }),
                (n.mousedownPosition = { x: 0, y: 0 }),
                (n.mouseupPosition = { x: 0, y: 0 }),
                (n.offset = { x: 0, y: 0 }),
                (n.scale = { x: 1, y: 1 }),
                (n.wheelDelta = 0),
                (n.button = -1),
                (n.pixelRatio =
                  n.element.getAttribute("data-pixel-ratio") || 1),
                (n.sourceEvents = {
                  mousemove: null,
                  mousedown: null,
                  mouseup: null,
                ...
                (n.mousemove = function (t) {
                  ...
                  t.changedTouches && ((n.button = 0), t.preventDefault()),
                    (n.absolute.x = o.x),
                    (n.absolute.y = o.y),
            ...
            (o.rectangle = function (e, t, n, o, a) {
              ...
              (o.fromVertices = function (e, t, n, o, d, u, p) {
                ...
                for (
                  ...
                  if (((y = n[b]), (v = i.isConvex(y)) || !c))
                    (y = v ? i.clockwiseSort(y) : i.hull(y)),
                      f.push({ position: { x: e, y: t }, vertices: y });
                  else {
                      ...
                      if (a.overlaps(P.bounds, B.bounds)) {
                        ...
                        for (h = 0; h < P.vertices.length; h++)
                          for (w = 0; w < B.vertices.length; w++) {
                            var I = l.magnitudeSquared(
                                l.sub(M[(h + 1) % M.length], k[w])
                              ),
                              T = l.magnitudeSquared(
                                l.sub(M[h], k[(w + 1) % k.length])
                              );
                            I < 5 &&
                              T < 5 &&
                              ((M[h].isInternal = !0), (k[w].isInternal = !0));
                          }
                      }
                    }
                  }
                return f.length > 1
                  ? ((m = s.create(r.extend({ parts: f.slice(0) }, o))),
                    s.setPosition(m, { x: e, y: t }),
                    m)
                  : f[0];
              });
          }).call(
          ...
          (t.exports = o),
            ...
            (function () {
              o.pathToVertices = function (t, n) {
                ...
                for (
                  e(t), r = t.getTotalLength(), l = [], o = 0;
                  o < t.pathSegList.numberOfItems;
                  o += 1
                )
        ...
        function (e, t, n) {
          ...
          (t.exports = o),
            ...
            (o.rotate = function (e, t) {
              var n = Math.cos(t),
                o = Math.sin(t);
              return { x: e.x * n - e.y * o, y: e.x * o + e.y * n };
            }),
          ...
          (o.create = function (e, t) {
            ...
            (o.chamfer = function (e, t, n, o, s) {
              ...
              for (var a = [], l = 0; l < e.length; l++) {
                ...
                if (0 !== p) {
                  var m = i.normalise({ x: d.y - c.y, y: c.x - d.x }),
                    f = i.normalise({ x: u.y - d.y, y: d.x - u.x }),
                    v = Math.sqrt(2 * Math.pow(p, 2)),
                    y = i.mult(r.clone(m), p),
                    g = i.normalise(i.mult(i.add(m, f), 0.5)),
            ...
            "undefined" != typeof window &&
              ...
              (o.lookAt = function (e, t, n, o) {
                ...
                v > f ? (g = v / f) : (y = f / v),
                  ...
                  o &&
                    ((e.bounds.min.x += 0.5 * u - u * y * 0.5),
                    (e.bounds.max.x += 0.5 * u - u * y * 0.5),
              ...
              (o.world = function (e) {
                ...
                !f.wireframes || (n.enableSleeping && f.showSleeping)
                  ? o.bodies(e, x, p)
                  : (f.showConvexHulls && o.bodyConvexHulls(e, x, p),
                ...
                for (var n = t, o = 0; o < e.length; o++) {
                  ...
                  if (i.render.visible && i.pointA && i.pointB) {
                    ...
                    r
                      ...
                      : (n.beginPath(), n.moveTo(i.pointA.x, i.pointA.y)),
                      s
                        ? n.lineTo(
                            s.position.x + i.pointB.x,
                            s.position.y + i.pointB.y
                          )
                        : n.lineTo(i.pointB.x, i.pointB.y),
                      i.render.lineWidth &&
                        ...
                        if (
                          ...
                          if (i.circleRadius)
                            ...
                            for (var m = 1; m < i.vertices.length; m++)
                              !i.vertices[m - 1].isInternal || c
                                ? a.lineTo(i.vertices[m].x, i.vertices[m].y)
                                : a.moveTo(i.vertices[m].x, i.vertices[m].y),
                                i.vertices[m].isInternal &&
                                  !c &&
                                  a.moveTo(
                                    i.vertices[(m + 1) % i.vertices.length].x,
                                    i.vertices[(m + 1) % i.vertices.length].y
                                  );
                  ...
                  if (
                    ...
                    2 === o.activeContacts.length &&
                      ...
                      i.bodyB === i.supports[0].body || !0 === i.bodyA.isStatic
                        ? a.moveTo(d - 8 * i.normal.x, u - 8 * i.normal.y)
                        : a.moveTo(d + 8 * i.normal.x, u + 8 * i.normal.y),
                      a.lineTo(d, u);
                  }
                l.wireframes
              ...
              (o.separations = function (e, t, n) {
                ...
                for (l.beginPath(), a = 0; a < t.length; a++)
                  if ((o = t[a]).isActive) {
                    ...
                    var d = 1;
                    (s = i.bodyB).isStatic || r.isStatic || (d = 0.5),
                      s.isStatic && (d = 0),
          ...
          !(function () {
            ...
            "undefined" != typeof window &&
              ...
              (o.setBackground = function (e, t) {
                if (e.currentBackground !== t) {
                  ...
                  if (n) {
                    ...
                    var r = d(e, t);
                    ((o = e.sprites["bg-0"] =
                      new PIXI.Sprite(r)).position.x = 0),
                      (o.position.y = 0),
              ...
              (o.world = function (e) {
                var t,
                  ...
                  p = [];
                c.wireframes
                  ? o.setBackground(e, c.wireframeBackground)
                  : o.setBackground(e, c.background);
                ...
                if (c.hasBounds) {
                  ...
                  for (t = 0; t < u.length; t++) {
                    ...
                    h && (w = l.add(h.position, x.pointA)),
                      ...
                      w &&
                        S &&
                        (i.contains(e.bounds, w) || i.contains(e.bounds, S)) &&
                        p.push(x);
                  }
                  a.scale.set(1 / v, 1 / y),
                    a.position.set(
                ...
                if (o.visible)
                  if (o.sprite && o.sprite.texture) {
                    ...
                    var l = "b-" + t.id,
                      ...
                      u = e.container;
                    d ||
                      ((d = e.primitives[l] = c(e, t)).initialAngle = t.angle),
            ...
            var n = function (e, t) {
                var n = t.render.sprite.texture,
                  ...
                  i = new PIXI.Sprite(o);
                return (
                  (i.anchor.x = t.render.sprite.xOffset),
              ...
              c = function (e, t) {
                ...
                for (
                  ...
                  for (var m = 1; m < n.vertices.length; m++)
                    r.lineTo(
                      n.vertices[m].x - t.position.x,
                      n.vertices[m].y - t.position.y
                    );
                  r.lineTo(
                    n.vertices[0].x - t.position.x,
                    n.vertices[0].y - t.position.y
